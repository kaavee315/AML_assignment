...
W0 = tf.Variable(tf.random_normal([2500, 1000],mean=0.00, stddev=0.001))
# W0 = tf.Print(W0, [W0], message="This is W0: ", summarize = 10)
b0 = tf.Variable(tf.random_normal([1000],mean=0.00, stddev=0.001))
...
W1 = tf.Variable(tf.random_normal([1000, 500],mean=0.00, stddev=0.001))
# W1 = tf.Print(W1, [W1], message="This is W1: ", summarize = 10)
b1 = tf.Variable(tf.random_normal	([500],mean=0.00, stddev=0.001))
